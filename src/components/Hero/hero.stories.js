  ...
  .add('without image', () => (
    <Hero title="Discover various roles on the platform">
      <p className="HeroStory__paragraph">
        ...
        This Privacy Policy ("Privacy Policy") and Cookie Policy
        ("Cookie Policy") explains how Jsgenesis AS ("Jsgenesis",
        "Company", "We", "Us", "Our") collect and use data and information
        when you ("User) use on or any of the Joystream products, developed in the GitHub organization
        <Link href="https://github.com/JoyStream"  highlighted> Joystream</Link>.
        These products (collectively "Software") include, but are not limited to, all pages under the
        <Link href="https://www.joystream.org/" highlighted> joystream.org </Link>
        domain ("Website"), the
        <Link href="https://github.com/Joystream/substrate-node-joystream" highlighted> Joyful node </Link>
        ("Full Node"), the
        <Link href="https://github.com/Joystream/storage-node-joystream" highlighted> Colossus Storage Node </Link>
        ("Storage node"), and the Pioneer User Interface, either
        <Link href="https://github.com/Joystream/apps" highlighted> self hosted </Link>
        or
        <Link href="http://testnet.joystream.org/" highlighted> hosted by Us </Link>
        ("App").
      </p>
    </Hero>
  ))
