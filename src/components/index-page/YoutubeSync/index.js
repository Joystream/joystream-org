    ...
    <div className='IndexPage__youtube-sync-wrapper'>
      <div className='IndexPage__youtube-sync'>
        <div className='IndexPage__youtube-sync__content'>
          ...
          <h2 className='IndexPage__youtube-sync__content__title'>Have your YouTube videos uploaded and backed up automatically</h2>
          <p className='IndexPage__youtube-sync__content__subtitle'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet rhoncus iaculis viverra nunc gravida a egestas. Urna pellentesque laoreet facilisis pharetra at arcu vitae.</p>
      ...
      <div className='IndexPage__youtube-sync-cta'>
        ...
        <h2 className='IndexPage__youtube-sync-cta__title'>Stay one step ahead. Join the future of online video content today.</h2>
        <ArrowButton
